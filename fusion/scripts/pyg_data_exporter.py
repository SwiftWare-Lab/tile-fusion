...
def export_adjacency_matrices(folder):
    for _, v in datasets.items():
        ...
        data_folder = os.path.join(folder, v['root'])
...
if __name__ == '__main__':
    export_features(sys.argv[1])
    export_adjacency_matrices(sys.argv[1])
