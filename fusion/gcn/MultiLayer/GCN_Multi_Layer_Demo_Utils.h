...
protected:
  ...
  Timer analysis() override {
    ...
    // for sampling
    //    sym_lib::CSC *Di1 =
    //    sym_lib::csr_to_csc(InTensor->LayerMaskedMatrices[0]); sym_lib::CSC
    //    *Di2 = sym_lib::csr_to_csc(InTensor->LayerMaskedMatrices[1]);
    Sp._num_w_partition =
...
public:
  ...
  ~GCNAllFusedParallel() { delete FusedCompSet; }
};
