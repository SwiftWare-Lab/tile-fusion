...
int main(const int argc, const char *argv[]) {
  ...
  //  stats = new swiftware::benchmark::Stats("GCN_IntraFusedParallel_Demo",
  //  "GCN", 7,
  //                                          tp._matrix_name, numThread);
  //  stats->OtherStats["PackingType"] = {Separated};
  //  GCNIntraFusedParallel *gcnParallel = new GCNIntraFusedParallel(inputs,
  //  stats); gcnParallel->run(); auto gcnParallelStat =
  //  gcnParallel->printStats(); delete gcnParallel; delete stats; std::cout <<
  //  gcnParallelStat << spStat + tpStat << std::endl;
...
//  }
  ...
  if (tp.expariment_name == "GCNWithDifferentFusionLevels") {
     ...
     */
        stats = new swiftware::benchmark::Stats("GCN_IntraTiledFused_Demo",
        "GCN", 7,
                                                tp._matrix_name, numThread);
        stats->OtherStats["PackingType"] = {Separated};
        GCNIntraLayerTiledFused *gcnIntraTiledFused = new
        GCNIntraLayerTiledFused(inputs, stats, tileSize);
     ...
     */
    stats =
        new swiftware::benchmark::Stats("GCN_IntraFusedCSCSequential_Demo",
                                        "GCN", 7, tp._matrix_name, numThread);
    stats->OtherStats["PackingType"] = {Separated};
     ...
     */
    stats = new swiftware::benchmark::Stats(
        "GCN_IntraTiledFusedCSC_Demo", "GCN", 7, tp._matrix_name, numThread);
    stats->OtherStats["PackingType"] = {Interleaved};
     ...
     * Inspection-Executor
     */
    stats = new swiftware::benchmark::Stats("GCN_AllTiledFusedCSC_Demo", "GCN",
