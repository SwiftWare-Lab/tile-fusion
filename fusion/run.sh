...
if [ $USE_PAPI -eq 1 ]; then
  ...
  cmake -DCMAKE_PREFIX_PATH="$MKL_DIR/lib/intel64;$MKL_DIR/include;$MKL_DIR/../compiler/lib/intel64;_deps/openblas-build/lib/;" -DSWIFT_BLAS_BACKEND="FLEXIBLAS"  -DCMAKE_BUILD_TYPE=Release ..
fi
make -j 40
